            ...
            <div className="mt-8 rounded-2xl bg-white border border-gray-100 shadow-sm p-6 flex flex-col md:flex-row items-center justify-between gap-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <h2 className="font-black text-lg text-gray-900 mt-1">Active University Leaves Directory</h2>
                        <p className="text-xs text-gray-500">
                            {analytics.activeLeavesList?.length || 0} staff members are currently on approved active leave across all units &amp; study centers.
                        </p>
                    </div>
                </div>

                <Link
                    href="/dashboard/unit/leaves?tab=active"
                    style={{ backgroundColor: '#006533', color: '#ffffff' }}
                    className="flex items-center gap-2 px-6 py-3 text-white text-xs font-bold rounded-xl shadow-md hover:opacity-90 transition flex-shrink-0"
                >

export const NIGERIAN_STATES_AND_LGAS: Record<string, string[]> = {
  ...
  "Anambra": [
    "Aguata", "Awka North", "Awka South", "Ayamelum", "Anaocha", "Dunukofia", 
    "Ekwusigo", "Idemili North", "Idemili South", "Ihiala", "Njikoka", "Nnewi North", 
    "Nnewi South", "Ogbaru", "Onitsha North", "Onitsha South", "Orumba North", 
    "Orumba South", "Oyi"
  ],
  "Bauchi": [
    "Alkaleri", "Bauchi", "Bogoro", "Damban", "Darazo", "Dass", "Gamawa", "Ganjuma", 
  ...
  "Ebonyi": [
    "Abakaliki", "Afikpo North", "Afikpo South", "Edda", "Ikwo", "Ishielu", 
  ...
  "Jigawa": [
    "Babura", "Biriniwa", "Birnin Kudu", "Buji", "Dutse", "Gagarawa", "Garki", 
    "Gumel", "Guri", "Gwaram", "Gwiwa", "Hadejia", "Jahun", "Kafin Hausa", 
  ...
  "Kano": [
    ...
    "Garun Mallam", "Gaya", "Gezawa", "Gwale", "Gwarzo", "Kabo", "Karaye", 
  ...
  "Katsina": [
    ...
    "Jibia", "Kafur", "Kankara", "Kankia", "Katsina", "Kurfi", "Kusada", 
    "Mai'Adua", "Malumfashi", "Mani", "Mashi", "Musawa", "Rimi", "Sabuwa", 
  ...
  "Niger": [
    ...
    "Mokwa", "Muya", "Paikoro", "Rafi", "Rijau", "Shiroro", "Suleja", "Tafa", 
    "Wushishi"
  ],
  "Ogun": [
  ...
  "Oyo": [
    ...
    "Ido", "Irepo", "Itesiwaju", "Iwajowa", "Kajola", "Lagelu", "Ogbomosho North", 
  ...
  "Rivers": [
    ...
    "Ikwerre", "Oyigbo", "Opobo/Nkoro", "Port Harcourt", "Tai", "Obio/Akpor", 
  ...
  "Taraba": [
    ...
    "Karim Lamido", "Kurmi", "Lau", "Sardauna", "Takum", "Ussa", "Wukari", "Zing"
  ],
  "Yobe": [
